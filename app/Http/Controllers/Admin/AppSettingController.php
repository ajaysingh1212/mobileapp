...
class AppSettingController extends Controller
{
    ...
    public function index()
    {
        ...
        $appSettings = AppSetting::with(['media'])->get();
    ...
    public function store(StoreAppSettingRequest $request)
    {
        ...
        if ($media = $request->input('ck-media', false)) {
            Media::whereIn('id', $media)->update(['model_id' => $appSetting->id]);
        }
    ...
    {
        abort_if(Gate::denies('app_setting_create') && Gate::denies('app_setting_edit'), Response::HTTP_FORBIDDEN, '403 Forbidden');
