        ...
        @can('setting_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/messages*") ? "c-show" : "" }} {{ request()->is("admin/view-datas*") ? "c-show" : "" }} {{ request()->is("admin/addresses*") ? "c-show" : "" }} {{ request()->is("admin/app-settings*") ? "c-show" : "" }}">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    @endcan
                    @can('view_data_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.view-datas.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/view-datas") || request()->is("admin/view-datas/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-user c-sidebar-nav-icon">

                                </i>
                                {{ trans('cruds.viewData.title') }}
                            </a>
                        </li>
                    @endcan
                    @can('address_access')
