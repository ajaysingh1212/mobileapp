...
<body>
  ...
  <section class="stark-login">
   ...
   <form method="POST" action="{{ route('login') }}">
    @csrf
      <div id="fade-box">
        <input id="email" name="email" id="username" type="text" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" required autocomplete="email" autofocus placeholder="{{ trans('global.login_email') }}" value="{{ old('email', null) }}">
...
<style>
    /* 23/02/2019 To Start the stark-login in the web from on the project created by Er-Robin Mishra and co founder by Er-Priyanka Tiwari  is besic on the HTML and CSS and strat the project 
so i am Er-Robin Mishra  */
* {
