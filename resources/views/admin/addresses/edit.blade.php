    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.addresses.update", [$address->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bank_account_number') ? 'is-invalid' : '' }}" type="text" name="bank_account_number" id="bank_account_number" value="{{ old('bank_account_number', $address->bank_account_number) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cif_number') ? 'is-invalid' : '' }}" type="text" name="cif_number" id="cif_number" value="{{ old('cif_number', $address->cif_number) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pan_card') ? 'is-invalid' : '' }}" type="text" name="pan_card" id="pan_card" value="{{ old('pan_card', $address->pan_card) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('atm_pin') ? 'is-invalid' : '' }}" type="text" name="atm_pin" id="atm_pin" value="{{ old('atm_pin', $address->atm_pin) }}">
